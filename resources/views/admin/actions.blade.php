...
@if( !in_array("show", $actions) && !in_array("modify", $actions) && !in_array("delete", $actions))
    <a class="" title="@lang('rapyd::rapyd.modify')" href="{!! url('panel/'.$current_entity.'/'.$uri) !!}?{!! $actions[0] !!}={!! $id !!}"><span class="glyphicon glyphicon-list-alt"> </span></a>
@endif
