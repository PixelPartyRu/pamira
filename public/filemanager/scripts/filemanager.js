...
$(function(){
	...
	$('#link-to-project').remove(); //attr('href', config.url).attr('target', '_blank').attr('title', lg.support_fm + ' [' + lg.version + ' : ' + config.version + ']');
...
$('button#select').on('click', function(){
        var url = $('#main-title:visible #copy-button').data('clipboard-text');
        $(top.tinymce.activeEditor.windowManager.windows[0].getEl('body')).find('input:first').val(url);
